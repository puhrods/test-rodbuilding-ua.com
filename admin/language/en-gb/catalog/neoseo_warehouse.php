...
$_['entry_code_1c'] = 'Warehouse code:';
...
$_['entry_update_only_main_product_category'] = 'Update only the main product category';
$_['entry_update_only_main_product_category_desc'] = "Product binding to categories in the 'Display in categories' block will not be reset. For this option to work properly, the 'Fill parent categories' option must be disabled";

$_['entry_export_discount_as_element'] = 'Export discount as a separate attribute';
$_['entry_export_discount_as_element_desc'] = "Export discounts as an attribute of the &lt;Discounts&gt;' document";
