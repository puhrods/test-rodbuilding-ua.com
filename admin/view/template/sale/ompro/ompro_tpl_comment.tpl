	...
	<div class="box-body">
		<div class="nav-tabs-custom">
		  <ul id="nav-tabs" class="nav nav-tabs">
            <li><a href="#tab-template" data-toggle="tab"><?php echo $tab_template_comment; ?></a></li>
            ...
            <div class="tab-pane" id="tab-template">
			  <div class="nav-tabs-custom">
				<div class="callout callout-default">
					<p><a class="btn btn-info btn-xs" style="text-decoration: none;" href="http://brest001.ru/ompro_doc/ompro_tpl_comment.html"  target="_blank" data-toggle="tooltip" title="<?php echo $text_doc_link; ?>" ><i class="fa fa-question-circle"></i>&nbsp;&nbsp; <?php echo $text_help; ?></a>&nbsp;&nbsp;<?php echo $text_template_comment_info; ?></p>
				</div>
				  ...
				  <?php foreach ($languages as $language) { ?>
					<div id="language<?php echo $language['language_id']; ?>" class="tab-pane">
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
							<textarea class="htmlTextArea form-control textarea-summernote" name="template[template][<?php echo $language['language_id']; ?>]"><?php echo isset($template['template'][$language['language_id']]) ? $template['template'][$language['language_id']] : ''; ?></textarea>
						  </div>
						</div>
					</div>
				  <?php } ?>
