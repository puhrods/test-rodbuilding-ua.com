		  ...
		  <div class="tab-content">
			<div class="tab-pane" id="tab-template">
			  ...
			  <div class="panel panel-default">
				<div class="panel-body">
				  <div class="callout callout-default">
					<p><a class="btn btn-info btn-xs" style="text-decoration: none;" href="http://brest001.ru/ompro_doc/ompro_tpl_filter_order.html"  target="_blank" data-toggle="tooltip" title="<?php echo $text_doc_link; ?>" ><i class="fa fa-question-circle"></i>&nbsp;&nbsp; <?php echo $text_help; ?></a>&nbsp;&nbsp; <?php echo $text_info_main; ?></p>
			  ...
			  <div class="panel-group">
					...
					<div id="set-search" class="panel-collapse collapse in">
					  <div class="panel-body">
							<div id="search-help" class="hidden-default">
								...
								<br/><i class="fa fa-exclamation-triangle text-blue"></i>&nbsp; <?php echo $text_filter_search_help2; ?>
								<br/><i class="fa fa-exclamation-triangle text-red"></i>&nbsp; <?php echo $text_filter_search_help3; ?>
								<br/><i class="fa fa-exclamation-triangle text-red"></i>&nbsp; <?php echo $text_filter_search_help6; ?>
								<br/><i class="fa fa-exclamation-triangle text-blue"></i>&nbsp; <?php echo $text_filter_search_help4; ?>
								<br/><i class="fa fa-exclamation-triangle text-blue"></i>&nbsp; <?php echo $text_filter_search_help5; ?>
								</p>
							</div>
				  ...
				  <!-- APPLY BUTTON -->
				  <div class="panel panel-default">
					<div class="panel-heading"><i class="fa fa-filter"></i>&nbsp;&nbsp;&nbsp;&nbsp;<a data-toggle="collapse" href="#set-applybtn"><span style="color: #95b6ca;"><i class="fa fa-sort"></i></span>&nbsp;&nbsp; <?php echo $text_apply_btn; ?></a></div>
					  ...
					  <div class="col-sm-1">
						...
						<div class="panel">
						  <select name="template[btn_apply_status]" id="input-table-head"  class="form-control">
							<option value="1" <?php if (isset($template['btn_apply_status']) && $template['btn_apply_status'] == 1) { ?> selected="selected"<?php } ?>><?php echo $text_enabled; ?></option>
							<option value="0" <?php if (isset($template['btn_apply_status']) && $template['btn_apply_status'] == '0') { ?> selected="selected"<?php } ?>><?php echo $text_disabled; ?></option>
						  </select>
						</div>
					  </div>
					  <div class="col-sm-1">
						...
						<div class="panel">
						  <select name="template[btn_apply_position]" class="form-control">
							<option value="right" <?php if (isset($template['btn_apply_position']) && $template['btn_apply_position'] == 'right') { ?> selected="selected"<?php } ?>><?php echo $text_right; ?></option>
							<option value="left" <?php if (isset($template['btn_apply_position']) && $template['btn_apply_position'] == 'left') { ?> selected="selected"<?php } ?>><?php echo $text_left; ?></option>
						  </select>
						</div>
					  </div>
					  <div class="col-sm-2">
						...
						<div class="panel">
							<select name="template[btn_apply_type]" class="form-control">
								<option value="icon" <?php if (isset($template['btn_apply_type']) && $template['btn_apply_type'] == 'icon') { ?> selected="selected"<?php } ?>><?php echo $text_btn_type_icon; ?></option>
								<option value="text" <?php if (isset($template['btn_apply_type']) && $template['btn_apply_type'] == 'text') { ?> selected="selected"<?php } ?>><?php echo $text_btn_type_text; ?></option>
								<option value="icontext" <?php if (isset($template['btn_apply_type']) && $template['btn_apply_type'] == 'icontext') { ?> selected="selected"<?php } ?>><?php echo $text_btn_type_icon_text; ?></option>
								<option value="icontext" <?php if (isset($template['btn_apply_type']) && $template['btn_apply_type'] == 'texticon') { ?> selected="selected"<?php } ?>><?php echo $text_btn_type_text_icon; ?></option>
							</select>
						</div>
					  </div>
					  <div class="col-sm-2">
						...
						<div class="panel">
						  <div class="input-group">
							<span class="input-group-addon" data-toggle="tooltip" title="<?php echo $text_btn_info_title_type; ?>"><i class="fa fa-info text-blue"></i></span>
							<input type="text" name="template[btn_apply_title]" value="<?php echo isset($template['btn_apply_title']) && !empty($template['btn_apply_title']) ? $template['btn_apply_title'] : $text_apply; ?>" class="form-control" />
						  </div>
						</div>
					  </div>
					  <div class="col-sm-2">
						...
						<div class="panel">
						  <div class="input-group">
							<span class="input-group-addon" data-toggle="tooltip" title="<?php echo $text_btn_text_info; ?>"><i class="fa fa-info text-blue"></i></span>
							<input type="text" name="template[btn_apply_text]" value="<?php echo isset($template['btn_apply_text']) && !empty($template['btn_apply_text']) ? $template['btn_apply_text'] : $text_apply; ?>" class="form-control" />
						  </div>
						</div>
					  </div>
					  <div class="col-sm-2">
						...
						<div class="panel valid-block">
						  <div class="input-group">
							<span class="input-group-addon" data-toggle="tooltip" title="<?php echo $text_btn_class_info; ?>"><i class="fa fa-info text-blue"></i></span>
							<input type="text" name="template[btn_apply_class]" value="<?php echo isset($template['btn_apply_class']) && !empty($template['btn_apply_class']) ? $template['btn_apply_class'] : 'btn btn-primary'; ?>" class="field-input validclass form-control" placeholder="btn btn-primary" />
						  </div>
						</div>
					  </div>
					  <div class="col-sm-2">
						...
						<div class="panel valid-block">
						  <div class="input-group">
							<span class="input-group-addon" data-toggle="tooltip" title="<?php echo $text_icon_class_info; ?>"><i class="fa fa-info text-blue"></i></span>
							<input type="text" name="template[btn_apply_icon]" value="<?php echo isset($template['btn_apply_icon']) && !empty($template['btn_apply_icon']) ? $template['btn_apply_icon'] : 'fa fa-filter'; ?>" class="field-input validclass form-control" placeholder="fa fa-filter" />
						  </div>
						</div>
					  </div>
...
<div id="hidden_elements" style="display: none;">
		  ...
		  <tr>
			<td colspan="3" class="valid-block">
			  <div class="input-group" style="width: 100%;">
				<span class="input-group-addon" data-toggle="tooltip" title="<?php echo $text_filter_manual_input; ?>"><i class="fa fa-info text-blue"></i></span>
  ...
  <div class="col-sm-12" id="multiselect_col" style="margin-top: 15px;">
	<div class="panel panel-default">
	  <div class="panel-heading">
		<h1 class="panel-title"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;<?php echo $text_title_multiselect; ?>&nbsp;&nbsp;<span class="text-blue" style="font-size: 13px;"><a href="http://davidstutz.de/bootstrap-multiselect/" target="_blank"><?php echo $text_documentation_multiselect; ?></a></span></h1>
	  </div>
	  <div class="panel-body">
		<div class="row">
		  <div class="col-sm-2">
		  ...
		  <div class="col-sm-2">
			...
			<div class="panel valid-block">
			  <div class="input-group">
				...
				<input type="text" name="template[multiselect][selAllIfMo]" value="<?php echo isset($template['multiselect']['selAllIfMo']) ? $template['multiselect']['selAllIfMo'] : 1; ?>" class="field-input numeric form-control" placeholder="10" />
			  </div>
			</div>
		  </div>
...
$(document).delegate('#filter_id', 'change', function() {
	...
	$.ajax({
		url: 'index.php?route=sale/ompro_helper/testFilterId&<?php echo $strtoken; ?>&type=filter&template_id=' + template_id + '&filter_id=' + filter_id,
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('.btn-preview', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=sale/ompro/previewFilter&<?php echo $strtoken; ?>&type=filter&template_id=' + template_id + '&location=' + loc,
		dataType: 'json',
		beforeSend: function() {
