			  ...
			  <div class="form-group valid-block">
				<span class="input-group">
					<span class="input-group-btn">
						<a class="btn btn-info" href="http://brest001.ru/ompro_doc/ompro_tpl_block_page.html"  target="_blank" data-toggle="tooltip" title="<?php echo $text_doc_link; ?>" ><i class="fa fa-question-circle"></i></a>
					</span>
	...
	<div class="box-body box-content hidden-default">
		<div class="nav-tabs-custom">
		  <ul id="nav-tabs" class="nav nav-tabs">
            <li><a href="#tab-template" data-toggle="tab"><?php echo $text_tab_template_page_block; ?></a></li>
		  ...
		  <div class="tab-content">
			<div class="tab-pane" id="tab-template">
				<div class="callout callout-default">
					<p><i class="fa fa-exclamation-triangle text-blue"></i> <?php echo $text_tab_template_page_block_help; ?>
					<br/><i class="fa fa-exclamation-triangle text-red"></i> <?php echo $text_tab_template_page_block_help2; ?></p>
				</div>
				<div class="panel-group">
				  <div class="panel panel-default">
					<div class="panel-heading"><a data-toggle="collapse" href="#attr-info"><i class="fa fa-sort text-blue"></i>&nbsp;&nbsp; <?php echo $text_vars_and_attr; ?></a></div>
					<div id="attr-info" class="panel-collapse collapse">
					  <div class="panel-body">
						<div class="row">
							<div class="col-lg-12" style="height: 300px; overflow: auto;"><?php echo $table_btn_actions; ?></div>
						</div>
					  </div>
					  <div class="panel-body">
						<div class="row">
							<div class="col-lg-12" style="height: 300px; overflow: auto;"><?php echo $table_option_vars; ?></div>
						</div>
					  </div>
					  <div class="panel-body">
						<div class="row">
							<div class="col-lg-12" style="max-height: 300px; overflow: auto;"><?php echo $quick_filter_trigger_info; ?></div>
						</div>
					  </div>
					</div>
				  </div>
				  ...
				  <div class="panel panel-default">
					<div class="panel-heading"><a data-toggle="collapse" href="#page-var-info"><i class="fa fa-sort text-blue"></i>&nbsp;&nbsp; <?php echo $text_page_value_vars; ?></a></div>
					<div id="page-var-info" class="panel-collapse collapse">
					  <div class="panel-body">
						<div class="row">
							<div class="col-lg-12" style="max-height: 300px; overflow: auto;"><?php echo $table_page_value_vars; ?></div>
						</div>
					  </div>
					</div>
				  </div>
...
$(document).ready(function(){
	...
	$('.textarea-summernote').summernote({
		blank: '', emptyPara: '', lang: lang, height: 560, width: '98%', toolbar: toolbar,fontNames: fontNames, placeholder: placeholder,
