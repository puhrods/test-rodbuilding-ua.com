...
$_['oct_to_contacts'] = "Перейти до контактів";
...
$_['oct_product_timer'] = "Акція закінчується через:";
...
$_['tab_oct_faq'] = "<span class=\"nav-link-text\">Запитання</span> <span class=\"nav-link-qty\">(%s)</span>";
$_['text_faq'] = "Задати питання";
$_['text_faq_textarea'] = "Ваше запитання";
$_['text_faq_text'] = "Якщо у Вас є питання щодо цього товару, заповніть форму нижче, і ми відповімо найближчим часом.";
$_['text_faq_success'] = "Ваше питання успішно надіслано і незабаром буде опубліковано разом з відповіддю адміністратора.";
$_['text_faq_title'] = "Немає питань про цей товар, станьте першим і поставте своє питання.";
$_['text_faq_button'] = "+ Задати питання";
$_['text_faq_autor'] = "Питання від:";
$_['text_faq_answer'] = "Відповідь:";
$_['error_faq_name'] = "Ім&#39;я має бути від 3 до 25 символів!";
$_['error_faq_text'] = "Текст питання має бути від 25 до 1000 символів!";