...
class URLify {
	 ...
	 */
	public static function filter ($text, $length = 60, $language = "", $file_name = false, $use_remove_list = true, $lower_case = true, $treat_underscore_as_space = true, $separator='-') {
		...
		$text = preg_replace ('/[-\s]+/u', $separator, $text);    // convert spaces to hyphens
		if ($lower_case) {
